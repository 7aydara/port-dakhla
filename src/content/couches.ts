...
export const COUCHES: readonly Couche[] = [
  ...
  },
  {
    ...
    teinte: 'var(--magenta-carte)',
    details: [
      { nom: 'Commerce, −16 m', valeur: 660, unite: 'm', teinte: 'var(--magenta-carte)' },
      ...
      { nom: 'Poste pétrolier', note: POSTE_PETROLIER.note, teinte: 'var(--ecume-40)' },
    ],
  },
  {
    cle: 'zone',
    ...
    teinte: 'var(--sable)',
    details: [
      { nom: 'Route de raccordement à la RN 1', valeur: 7, unite: 'km', teinte: 'var(--ecume-40)' },
    ],
  },
];
